...
urlpatterns = patterns('',
    ...
    url(r'^reporte/proyecto/items/(?P<id_proyecto>\d+)$','reportes.reportes.descargar_reporteItems'),
    url(r'^reporte/proyecto/versionesItems/(?P<id_proyecto>\d+)$','reportes.reportes.descargar_reporteVersionesItems'),
    url(r'^reporte/proyecto/solicitudesCambio/(?P<id_proyecto>\d+)$','reportes.reportes.descargar_reporteSolicitudes'),
    url(r'^reporte/proyecto/lineasBase/(?P<id_proyecto>\d+)$','reportes.reportes.descargar_reporteLB'),
